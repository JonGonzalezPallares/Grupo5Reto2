 ...
 * Use the [Laberinto_exp2.newInstance] factory method to
 * create an instance of this fragment.
 */
class Laberinto_exp2 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val vista = inflater.inflate(R.layout.fragment_laberinto_exp2, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment Laberinto_exp2.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            Laberinto_exp2().apply {
