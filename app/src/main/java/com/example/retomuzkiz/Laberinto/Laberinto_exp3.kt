 ...
 * Use the [Laberinto_exp3.newInstance] factory method to
 * create an instance of this fragment.
 */
class Laberinto_exp3 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val vista = inflater.inflate(R.layout.fragment_laberinto_exp3, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment Laberinto_exp3.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            Laberinto_exp3().apply {
