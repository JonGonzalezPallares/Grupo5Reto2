 ...
 * Use the [PuenteRomano_preg2.newInstance] factory method to
 * create an instance of this fragment.
 */
class PuenteRomano_preg2 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val vista = inflater.inflate(R.layout.fragment_puente_romano_preg2, container, false)
        val saltar = vista.findViewById<ImageButton>(R.id.btnSaltar2)

        //Campo de texto donde va a estar el enunciado
        val texto = vista.findViewById<TextView>(R.id.txtPreg2)
    ...
    companion object {
         ...
         * @return A new instance of fragment PuenteRomano_preg2.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PuenteRomano_preg2().apply {
